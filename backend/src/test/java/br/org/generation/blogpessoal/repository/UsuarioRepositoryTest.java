...
public class UsuarioRepositoryTest {
	...
	void start() throws ParseException {
		...
		Usuario usuario = new Usuario(0, "João da Silva", "joao@email.com.br", "13465278", true, data);
		...
		usuario = new Usuario(0, "Frederico da Silva", "frederico@email.com.br", "13465278", true, data);
		if(usuarioRepository.findByLogin(usuario.getLogin()) != null)
			usuarioRepository.save(usuario);
